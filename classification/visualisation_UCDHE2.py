...
#  CONFIG
# ══════════════════════════════════════════════════════════════════════
BASE      = Path(r"C:\Users\PC\rehab-motion-analysis\classification\UCDHE_clf_mc_Rowing\fold0\run0")
REP_CSV   = BASE / "class_a" / "representatives.csv"
EXERCISE  = "UCDHE_CLF_MC_Rowing — Rowing"
FPS       = 8
TRACE_STEP = 15
...
# ══════════════════════════════════════════════════════════════════════
CHAINS = [
    [2, 1, 0],       # main G → coude G → épaule G
    [5, 4, 3],       # main D → coude D → épaule D
    [0, 3],          # épaule G ── épaule D
    [0, 6],          # épaule G → hanche G
    [3, 7],          # épaule D → hanche D
    [6, 7],          # hanche G ── hanche D
]
CHAIN_COLORS = [
