...
#  CONFIG
# ══════════════════════════════════════════════════════════════════════
BASE      = Path(r"C:\Users\PC\rehab-motion-analysis\classification\KINECAL_clf_bn_QSEC\fold0\run0")
REP_CSV   = BASE / "class_0" / "representatives.csv"
EXERCISE  = "KINECAL_CLF_BN_QSEC — Quiet Standing Eyes Closed"
FPS       = 8
TRACE_STEP = 10
...
# ══════════════════════════════════════════════════════════════════════
#  SQUELETTE — extraction + centrage pelvis médian
# ══════════════════════════════════════════════════════════════════════
...
def redraw_trace():
    ...
    skel  = state['skel']
    n_fr  = skel.shape[0]
    cmap  = matplotlib.colormaps['Oranges']   # ← Oranges comme les autres

    # Squelettes fantômes espacés de TRACE_STEP frames
