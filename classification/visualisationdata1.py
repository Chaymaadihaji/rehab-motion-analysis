...
for exercise_dir in exercise_dirs:
    ...
    for class_dir in class_dirs:
        ...
        # Lire toutes les séquences représentantes
        clusters_reps = {}
        ...
        # Générer une vidéo pour CHAQUE séquence représentante de CHAQUE cluster
